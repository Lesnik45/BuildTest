...
void Tut_Continue()
{
	...
	sld = GetCharacter(NPC_GenerateCharacter("Sailor_1", "Pirate_1", "man", "man", 1, PIRATE, 0, false, F_SAILOR));
    sld.name 	= "Сандро";
    sld.lastname 	= "Торн";
	...
	blade = GetGeneratedItem("blade_18");
	...
	sld = GetCharacter(NPC_GenerateCharacter("Sailor_2", "Pirate_2", "man", "man", 1, PIRATE, 0, false, F_SAILOR));
    sld.name 	= "Джим";
	...
	blade = GetGeneratedItem("blade_20");
    GiveItem2Character(sld, blade);
	EquipCharacterByItem(sld, blade);
