...
// Rebbebion, фракции
//#define MAX_FRACTIONS     22

#define F_CITY        "city"        // город
#define F_MILITARY    "military"    // военные
#define F_SAILOR      "sailor"      // матросы
#define F_OFFICER     "officer"     // офицеры (из таверны)
#define F_TRADER      "trader"      // торговцы
#define F_SLAVE       "slave"       // рабы
#define F_CREOLE      "creole"      // креолы
#define F_PIRATE      "pirate"      // пираты и бандиты
#define F_MERCENARY   "mercenary"   // наёмники (ОЗГ-и)
#define F_SMUGGLER    "smuggler"    // контрабандисты
#define F_INDIAN      "indian"      // индейцы (Караибы)
#define F_CATHOLICS   "catholics"   // Католики
#define F_MONSTER     "monster"     // нежить
#define F_OTHER       "other"       // остальные (к примеру герметисты и остальные)
#define F_MALTESE     "maltese"     // мальтийцы
#define F_GVIK        "Gvik"        // ГВИК
#define F_FVIK        "Fvik"        // ФВИК
#define F_VOODOO      "voodoo"      // Меджик пипл - вуду пипл :)
#define F_PEARL       "pearl"       // Ловцы жемчуга
#define F_LEAGUE      "league"      // Лига
#define F_PROTESTANTS "protestants" // Протестанты
#define F_MISKITO     "miskito"     // Мискито
...
#define MAX_LOCATIONS		723 // boal //700
#define MAX_ISLANDS   28
#define MAX_COLONIES  32
