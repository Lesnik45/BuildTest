...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    if ( sti(Pchar.Ship.Type) != SHIP_NOTUSED)
    {
		...
		if(CheckAttribute(&RealShips[sti(Pchar.Ship.Type)], "QuestShip")) fQuestShip = 1.3;

		int sundukSum = makeint(((7-shipClass)*1.3) * fQuestShip);
		
	    int  cannonMatherial1 = makeint((cannonQ * 2 + 70 * (7-shipClass) - 20) * fQuestShip);
		...
		int  cannonWorkPrice  = makeint((100 * cannonQ * MOD_SKILL_ENEMY_RATE + 8000 * ((7-shipClass) * MOD_SKILL_ENEMY_RATE)) * fQuestShip);
	    
	    int  capacityMatherial1 = makeint((70 * (7-shipClass) + shipCapacity * 7/100) * fQuestShip);
	    int	 capacityMatherial2 = makeint((20 * (7-shipClass)+10) * fQuestShip);
	    int  capacityMatherial3 = sundukSum;
		int  capacityWorkPrice  = makeint((2 * shipCapacity * MOD_SKILL_ENEMY_RATE + 8000 * ((7-shipClass) * MOD_SKILL_ENEMY_RATE)) * fQuestShip);
	    
	    int  SpeedRateMatherial1 = makeint((shipHP * 25/1000 + 140 * (7-shipClass)) * fQuestShip);
	    int	 SpeedRateMatherial2 = makeint(10 * (7-shipClass) * fQuestShip);
	    int	 SpeedRateMatherial3 = sundukSum;
		int  SpeedRateWorkPrice  = makeint((100 * shipSpeedRate * MOD_SKILL_ENEMY_RATE + 8000 * ((7-shipClass) * MOD_SKILL_ENEMY_RATE)) * fQuestShip);
	    
	    int  MaxCrewMatherial1 = makeint((shipMaxCrew * 6/10 + 100 * (7-shipClass)) * fQuestShip);
	    int	 MaxCrewMatherial2 = makeint((11 * (7-shipClass)+3) * fQuestShip);
	    int	 MaxCrewMatherial3 = sundukSum;
		int  MaxCrewWorkPrice  =  makeint((15 * shipMaxCrew * MOD_SKILL_ENEMY_RATE + 8000 * ((7-shipClass) * MOD_SKILL_ENEMY_RATE)) * fQuestShip);
	    
	    int  TurnRateMatherial1 = makeint((shipHP * 25/1000 + 750/shipClass+20) * fQuestShip);
	    int	 TurnRateMatherial2 = makeint((10 * (7-shipClass)+2) * fQuestShip);
	    int	 TurnRateMatherial3 = sundukSum;
		int  TurnRateWorkPrice  = makeint((30 * shipTurnRate * MOD_SKILL_ENEMY_RATE + 8000 * ((7-shipClass) * MOD_SKILL_ENEMY_RATE)) * fQuestShip);
	    
	    int  HPMatherial1 = makeint((70 * (7-shipClass) + shipHP * 7/100) * fQuestShip);
	    int	 HPMatherial2 = makeint(10 * ((7-shipClass)*3) * fQuestShip);
	    int	 HPMatherial3 = sundukSum;
		int  HPWorkPrice  = makeint((shipHP * MOD_SKILL_ENEMY_RATE + 8000 * ((7-shipClass) * MOD_SKILL_ENEMY_RATE)) * fQuestShip);
	    
	    int  WindAgainstMatherial1 = makeint((shipHP * 25/1000 + 1500/shipClass+20) * fQuestShip);
	    int	 WindAgainstMatherial2 = makeint((11 * (7-shipClass)+1) * fQuestShip);
	    int	 WindAgainstMatherial3 = sundukSum;
		int  WindAgainstWorkPrice  = makeint((300 * shipSpeedRate * MOD_SKILL_ENEMY_RATE + 8000 * ((7-shipClass) * MOD_SKILL_ENEMY_RATE)) * fQuestShip);
	    
		int quantityMatherial1 = makeint((cannonQ * 2 + 70 * (7-shipClass) - 20) * fQuestShip);
		...
		int cannonQWorkPrice = makeint((100 * cannonMaxQ * MOD_SKILL_ENEMY_RATE + 8000 * ((7-shipClass) * MOD_SKILL_ENEMY_RATE)) * fQuestShip);
        ...
        case "ship_tunning_start":
            ...
            else
            {
			    ...
			    else
			    {
					...
					if (cannonMax < 32 && cannonDiff > 0 && !CheckAttribute(&RealShips[sti(Pchar.Ship.Type)], "Tuning.Cannon"))
					{
