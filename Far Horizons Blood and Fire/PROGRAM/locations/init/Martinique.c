...
{	
	...
	locations[n].locators_radius.reload.reload1_back = 2.8;
	...
	locations[n].locators_radius.reload.reload2_back = 2.8;
	...
	locations[n].reload.gate.label = "ExitTown1";
	
    // --> Квестовые локации.

	locations[n].reload.l14.name = "basement1";
	...
	locations[n].reload.l21.go = "CommonRoom_MH9";
	locations[n].reload.l21.emerge = "reload1";
	locations[n].reload.l21.autoreload = "0";
	locations[n].reload.l21.label = "House";

	locations[n].reload.l22.name = "houseS1";
	locations[n].reload.l22.go = "CommonResidence_2";
	...
	locations[n].reload.l38.name = "houseK17";
	...
	//Models
	//Always
	locations[n].filespath.models = "locations\inside\PortOffice_KNS1";
	locations[n].models.always.housePortOffice = "PortOffice_KNS1";
	locations[n].models.always.housePortOffice.level = 65538;
	locations[n].models.always.locators = "PortOffice_KNS1_locators";
	Locations[n].models.always.l1 = "PortOffice_KNS1_backgraund";
	Locations[n].models.always.l1.level = 9;

	Locations[n].models.always.PortOffice = "PortOffice_KNS1_windows";
	Locations[n].models.always.PortOffice.tech = "LocationWindows";
	locations[n].models.always.PortOffice.level = 65539;

	//Day
	locations[n].models.day.charactersPatch = "PortOffice_KNS1_patch";
	//Night
	locations[n].models.night.charactersPatch = "PortOffice_KNS1_patch";
	//Environment
	locations[n].environment.weather = "true";
	locations[n].environment.sea = "true";
	...
	Locations[n].models.always.shore07_dock = "shore07_dock";
	Locations[n].models.always.shore07_dock.tech = "DLightModel";
	Locations[n].models.always.shore07_pier = "shore07_pier";
	Locations[n].models.always.shore07_pier.tech = "DLightModel";
	Locations[n].models.always.locators = "Shore07_locators_pier";
	Locations[n].models.always.jumpPatch = "shore07_jump";
	...
	Locations[n].models.always.l3.tech = "LocationModelBlend";	
	//Day
	locations[n].models.day.fd = "shore07_fd";
	locations[n].models.day.fd.tech = "DLightModel";
	locations[n].models.day.charactersPatch = "shore07_patch_dock_day";
	//Night
	locations[n].models.night.fn = "shore07_fn";
	locations[n].models.night.fn.tech = "DLightModel";
	...
	//VolumeLight	
	Locations[n].models.day.vlight = "storeSmall_vlight";
	Locations[n].models.day.vlight.uvslide.v0 = 0.05;
    Locations[n].models.day.vlight.uvslide.v1 = 0.0;
	Locations[n].models.day.vlight.tech = "LocationWaterFall";
	//Locations[n].models.day.vlight.tech = "LocVisRays";
	Locations[n].models.day.vlight.level = 99950;
