...
int LocationInitBoarding(int n)
{
	...
	locations[n].models.always.l1.lights = 1;

	Locations[n].models.always.drinks = "camp_deck_drinks";
	Locations[n].models.always.drinks.showstate = 0;
	Locations[n].models.always.drinks.tech = "DLightModel";
	Locations[n].models.always.drinks.lights = 1;
	
	Locations[n].models.always.cards_r = "camp_deck_cards_rich";
	Locations[n].models.always.cards_r.showstate = 0;
	Locations[n].models.always.cards_r.tech = "DLightModel";
	Locations[n].models.always.cards_r.lights = 1;
	
	Locations[n].models.always.cards_p = "camp_deck_cards_poor";
	Locations[n].models.always.cards_p.showstate = 0;
	Locations[n].models.always.cards_p.tech = "DLightModel";
	Locations[n].models.always.cards_p.lights = 1;
	
	Locations[n].models.always.window = "camp_deck_w";
	Locations[n].models.always.window.tech = "LocationWindows";
	locations[n].models.always.window.level = 65539;
	locations[n].models.always.window.lights = 1;

	//Day
	Locations[n].models.day.charactersPatch = "camp_deck_pd";
	Locations[n].models.day.interrior = "camp_deck_Int_D";
	Locations[n].models.day.interrior.tech = "DLightModel";
	Locations[n].models.day.interrior.lights = 1;
	Locations[n].models.day.fonar = "camp_deck_fd";
	Locations[n].models.day.fonar.tech = "DLightModel";
	Locations[n].models.day.fonar.lights = 1;

	//Night
	Locations[n].models.night.charactersPatch = "camp_deck_pn";
	Locations[n].models.night.interrior = "camp_deck_Int_N";
	Locations[n].models.night.interrior.tech = "DLightModel";
	Locations[n].models.night.interrior.lights = 1;
	Locations[n].models.night.fonar = "camp_deck_fn";
	Locations[n].models.night.fonar.tech = "DLightModel";
	Locations[n].models.night.fonar.lights = 1;
	...
	locations[n].models.day.fonar.tech = "DLightModel";
	locations[n].models.day.fonar.lights = 1;
	Locations[n].models.day.jumpPatch = "hold_jamp";
	//Night
	Locations[n].models.night.charactersPatch = "hold_p";
	Locations[n].models.night.fonar = "hold_fn";
	locations[n].models.night.fonar.tech = "DLightModel";
	locations[n].models.night.fonar.lights = 1;
	Locations[n].models.night.jumpPatch = "hold_jamp";
	//Environment
	Locations[n].environment.weather = "true";
	Locations[n].environment.sea = "false";
