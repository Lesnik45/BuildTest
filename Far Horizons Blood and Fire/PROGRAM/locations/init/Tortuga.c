int LocationInitTortuga(int n)
{
	...
	locations[n].reload.l32.go = "Common_FlamHut";
	...
	locations[n].reload.l1.go = "Tortuga_Lighthouse";
	locations[n].reload.l1.emerge = "reload1";
	locations[n].reload.l1.autoreload = "1";
	locations[n].reload.l1.label = "Tortuga_Lighthouse";
