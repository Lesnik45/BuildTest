int LocationInitSantaCatalina(int n)
{
	...
	locations[n].filespath.models = "locations\Town_Placeholder\Town\";
	...
	//Models
	//Always
	locations[n].models.always.town = "Placeholder";
	locations[n].models.always.town.sea_reflection = 1;
	locations[n].models.always.town.tech = "DLightModel";
	locations[n].models.always.locators = "Placeholder_locators";
	
	//Day
	locations[n].models.day.charactersPatch = "Placeholder_patch_day";
	//Night
	locations[n].models.night.charactersPatch = "Placeholder_patch_night";
	//Environment
