...
bool LoadLocation(ref loc)
{
	...
	SetEventHandler("Control Activation","chrCharacterKeys",1);
...
bool UnloadLocation(aref loc)
{
	...
	DelEventHandler("Control Activation","chrCharacterKeys");
...
void ShowAllLocators()
{
	...
	VisibleLocatorsGroup("Mushketer", 1.0, 15.0, 255, 255, 100, 200); //Экку Korsar - проявляем новые локаторы для мушкетеров
	VisibleLocatorsGroup("EliteProtector", 1.0, 15.0, 255, 255, 100, 200); // Rebbebion, новые локаторы для элитной стражи
	VisibleLocatorsGroup("PatrolElite", 1.0, 15.0, 255, 255, 100, 200); // Rebbebion, новые локаторы для элитной стражи
	VisibleLocatorsGroup("HGuardProtector", 1.0, 15.0, 255, 255, 100, 200); // Rebbebion, новые локаторы для стражи генерал-губернатора
	VisibleLocatorsGroup("HGuardPatrol", 1.0, 15.0, 255, 255, 100, 200); // Rebbebion, новые локаторы для патруля генерал-губернатора
...
void HideAllLocators()
{
	...
	HideLocatorsGroup("Mushketer"); //Экку Korsar - прячем новые локаторы для мушкетеров
	HideLocatorsGroup("EliteProtector"); // Rebbebion, новые локаторы для элитной стражи
	HideLocatorsGroup("PatrolElite"); // Rebbebion, новые локаторы для элитной стражи
	HideLocatorsGroup("HGuardProtector"); // Rebbebion, новые локаторы для стражи генерал-губернатора
	HideLocatorsGroup("HGuardPatrol"); // Rebbebion, новые локаторы для патруля генерал-губернатора
