...
void CreateBackEnvironment()
{
	...
	SendMessage(&InterfaceBackScene, "ls", 0, "MainMenu\NewMenu\MainMenu"); // set model
...
void MainMenu_CreateAnimals()
{
	...
	{
		InterfaceBackScene.seagull.locator = "seagull";
	    InterfaceBackScene.seagull.model = "Characters\pirate_10";
	    InterfaceBackScene.seagull.animation = "man";
	    InterfaceBackScene.seagull.aniaction = "Ground_sitting_mm";
	}
	
	if(rand(1) == 1 || Whr_IsNight())
	{
		InterfaceBackScene.seagull2.locator = "seagull2";
	    InterfaceBackScene.seagull2.model = "Characters\pirate_16";
	    InterfaceBackScene.seagull2.animation = "man";
	    InterfaceBackScene.seagull2.aniaction = "Ground_sitting_mm";
	}
	else
	{
		InterfaceBackScene.seagull2.locator = "seagull2";
	    InterfaceBackScene.seagull2.model = "mainmenu\seagull";
	    InterfaceBackScene.seagull2.animation = "seagull";
	    InterfaceBackScene.seagull2.aniaction = "idle";
	}
	
	SendMessage(&InterfaceBackScene, "ls", 9, "seagull" );
	
	SendMessage(&InterfaceBackScene, "ls", 9, "seagull2" );
}
