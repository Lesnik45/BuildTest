...
string GetLevelComplexity(int _Level_Complexity)
{
	...
	{
		case 3:
            return XI_ConvertString("m_Complexity_3"); // юнга
        break;
     
        case 6:
            return XI_ConvertString("m_Complexity_6"); // капитан
        break;
       
        case 9:
            return XI_ConvertString("m_Complexity_9"); // адмирал
        break;
			
        case 10:
            return XI_ConvertString("m_Complexity_10"); // хозяин морей
        break;
    }
}
