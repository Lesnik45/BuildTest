...
void InitTableHeader()
{
	...
	GameInterface.TABLE_HUMAN.tr1.td2.str = Statistic_AddValue(pchar, "soldier_s", 0);
	GameInterface.TABLE_HUMAN.tr1.td3.str = Statistic_AddValue(pchar, "soldier_g", 0);
	...
	GameInterface.TABLE_HUMAN.tr5.td2.str = Statistic_AddValue(pchar, "soldier_s", 0) + Statistic_AddValue(pchar, "Citizen_s", 0) + Statistic_AddValue(pchar, "Monster_s", 0) + Statistic_AddValue(pchar, "Warrior_s", 0);
	GameInterface.TABLE_HUMAN.tr5.td3.str = Statistic_AddValue(pchar, "soldier_g", 0) + Statistic_AddValue(pchar, "Citizen_g", 0) + Statistic_AddValue(pchar, "Monster_g", 0) + Statistic_AddValue(pchar, "Warrior_g", 0);
