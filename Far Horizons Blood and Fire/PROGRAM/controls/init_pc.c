...
// Character ===================================================================
    ...
    CI_CreateAndSetControls( "PrimaryLand", "UsePotionv1", CI_GetKeyCode("KEY_F"), 0, true ); // Зелье 1
	MapControlToGroup("UsePotionv1","FightModeControls");
	
	CI_CreateAndSetControls("PrimaryLand", "UsePotionv2", CI_GetKeyCode("KEY_C"), 0, true);// Зелье 2
	MapControlToGroup("UsePotionv2", "FightModeControls");
