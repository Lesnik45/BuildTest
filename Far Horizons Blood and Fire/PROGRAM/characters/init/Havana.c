...
int CreateHavanaCharacters(int n)
{
	...
	makeref(ch,Characters[n]);			//Генерал-губернатор Испании
	ch.id		= "Spa_GovernorGeneral";
	ch.model	= "Gascon";
	ch.name = "Франсиско";
	ch.lastname = "Орехон-и-Гаскон";
	ch.sex = "man";
	ch.City = "Havana";
	ch.location	= "Havana_GovernorGeneralTownhall";
	...
	ch.id		= "Havana_trader";
	ch.name = "Жоаким";
	ch.lastname = "Мерриман";
	ch.model	= "Trader_Havana";
