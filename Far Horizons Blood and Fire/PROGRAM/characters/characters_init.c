...
void CreateCharacters()
{
	...
	Characters[GetCharacterIndex("MainHero")].model.animation = "man";
    ...
    NullCharacter.GenQuestFort.Bridgetown.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.SanJuan.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.Santiago.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.SentJons.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.PortRoyal.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.FortOrange.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.Villemstad.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.BasTer.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.SantoDomingo.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.PortPax.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.FortFrance.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.Havana.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.Charles.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.PortoBello.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.PortSpein.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.Tortuga.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.Marigo.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.Panama.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.Cartahena.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.Maracaibo.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.Caracas.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.Cumana.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.SantaCatalina.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.Beliz.howsoldier  = 3;
    ...
    NullCharacter.GenQuestFort.LaVega.howsoldier  = 3;
