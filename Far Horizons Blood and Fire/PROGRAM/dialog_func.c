...
{ 
	...
	Address_Form.Dut.woman = "госпожа";
...
string FractionNameNominative(int iFraction) //именительный падеж
{
    switch(iFraction)
	{
		case F_CITY:
		...
		break;
		case F_PIRATE:
			return "Пираты и бандиты";
		break;
		case F_MERCENARY:
			return "Наёмники";
		break;
		case F_SMUGGLER:
			return "Контрабандисты";
		break;
		case F_INDIAN:
			return "Индейцы";
		break;
